...
<template>
  <div v-loading="isLoad" class="content-wrapper-manage content-wrapper-manage_task" style="position: relative;">
    ...
    <el-dialog
      ...
      @close="dialogClose"
      width="800px">
      <div class="mart20" style="width: 100%">
...
<script>
  import PartyMemberRegister from '../../common/develop_party_members/PartyMemberRegister.vue'
  export default {
    components: {
      'my-register-form': PartyMemberRegister,
    },
    data() {
      return {
        isLoad:           true,
    ...
    methods:{
      ...
      */
      getQueryUserList(){
        this.$request.requestAxios('get', basePath + '/hr_join_party_application/nopartymember', {params: {status: 1}},
          (response) => {
