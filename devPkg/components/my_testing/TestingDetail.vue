...
<template>
  <div class="content-area">
    <a href="#" class="back-button" @click="$router.push({name: 'My_Testing_List'})">返回</a>
    <el-form style="background: #fff" label-width="80px">
      ...
      <el-form-item label="试卷名称: ">
        <el-button v-if="detailData.testPaper.type == 1" type="text" @click="$router.push({name: 'My_Auto_Paper_Detail', params: {id: detailData.testPaper.id }})">{{ detailData.testPaper.theme }}</el-button>
        <el-button  v-if="detailData.testPaper.type == 2" type="text" @click="$router.push({name: 'My_Manual_Paper_Detail', params: {id: detailData.testPaper.id }})">{{ detailData.testPaper.theme }}</el-button>
      </el-form-item>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="primary" size="small" @click="$router.push({name: 'My_Check_Answer', params: {id: scope.row.id}})">查看</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
