...
<template>
  <div>
    <el-container>
      <el-aside v-if="isCollapse" v-loading="treeLoading" width="300px" class="tree-list-wrap">
        <el-tree
          style="min-height: 100%"
          ref="typeTree"
          :data="partyListData"
          class="tree-list padt20"
      ...
      <el-container style="position: relative;">
        ...
        <el-row class="right-content padt20" :gutter="20">
          <el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      initTree () {
        let self = this
        self.getDataList(`/party_orgs/top/single/tree`, "partyListData", false, { id: this.userData.partyOrgId }).then((response) => {
          if(response) {
