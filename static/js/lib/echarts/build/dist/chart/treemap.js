    ...
    return t.prototype = {
        ...
        refresh: function(e) {
            ...
            for (var t = this.series, i = this.component.legend, n = 0; n < t.length; n++)
                if (t[n].type === h.CHART_TYPE_TREEMAP) {
                    ...
                    var a = t[n].name || "";
                    if (this.selectedMap[a] = i ? i.isSelected(a) : !0,
                    !this.selectedMap[a])
                        continue;
        ...
        _buildTreemap: function(e, t) {
            for (var i = this.shapeList, n = 0; n < i.length; ) {
                var a = i[n];
                m.get(a, "seriesIndex") === t ? (this.zr.delShape(i[n]),
                i.splice(n, 1)) : n++
            }
            ...
            for (var f = new s({
                ...
                var x = g[_].data
                  ...
                  , W = [x.itemStyle, l]
                  , X = this.deepMerge(W);
                X.normal.color || (X.normal.color = this.zr.getColor(_)),
                X.emphasis.color || (X.emphasis.color = X.normal.color),
                this._buildItem(x, X, L, t, _),
                x.children && this._buildChildrenTreemap(x.children, X, L, t)
            }
        ...
        getLabel: function(e, t, i, a) {
            ...
            e.normal.label.show ? (e.normal.label.x + V > t.width || e.normal.label.y + U > t.height) && (h = "") : h = "",
            e.emphasis.label.show ? (s.x + u > t.width || s.y + y > t.height) && (p = "") : p = "";
            var g = {
                style: {
        ...
        getLabelText: function(e, t, i) {
            return i ? "function" == typeof i ? i.call(this.myChart, e, t) : "string" == typeof i ? (i = i.replace("{b}", "{b0}").replace("{c}", "{c0}"),
            i = i.replace("{b0}", e).replace("{c0}", t)) : void 0 : e
        },
        _buildChildrenTreemap: function(e, t, i, n) {
            ...
            for (var V = new s({
                ...
                (i.y + i.height).toFixed(2) !== (u.y + u.height).toFixed(2) && y.push(this._getLine(u.x, u.y + u.height, u.x + u.width, u.y + u.height, d, p)),
                (i.x + i.width).toFixed(2) !== (u.x + u.width).toFixed(2) && y.push(this._getLine(u.x + u.width, u.y, u.x + u.width, u.y + u.height, d, p));
                for (var g = 0; g < y.length; g++)
                    m.set(y[g], "seriesIndex", n),
                    this.shapeList.push(y[g])
            }
        },
        ...
        _buildBreadcrumb: function(e, t, i, n) {
            ...
            for (var s = this.series[t], l = this.query(s, "itemStyle.normal.breadcrumb.textStyle") || {}, h = this.query(s, "itemStyle.emphasis.breadcrumb.textStyle") || {}, V = {
                ...
                m.set(u, "seriesIndex", t),
                m.set(u, "name", a[c]),
                i += u.getRect(u.style).width,
...
define("echarts/data/Tree", ["require", "zrender/tool/util"], function(e) {
    ...
    i.fromOptionData = function(e, n) {
        ...
        for (var s = 0; s < n.length; s++)
            a(n[s], r);
        return o.root.updateDepthAndHeight(0),
        o
    }
    ,
    i.fromGraph = function(e) {
        ...
        for (var a = {}, o = {}, r = 0; r < e.nodes.length; r++) {
            var s, l = e.nodes[r];
            0 === l.inDegree() ? (a[l.id] = new i(l.id),
            s = a[l.id].root) : s = new t(l.id),
            s.data = l.data,
            o[l.id] = s
        }
        var h = [];
        for (var m in a)
            n(a[m].root),
            a[m].root.updateDepthAndHeight(0),
            h.push(a[m]);
        return h
    }
    ,
